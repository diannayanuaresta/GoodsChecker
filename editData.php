                                        ...
                                        <div class="row text-white">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    ...
                                                    <input name="jumlah_barang" type="number" class="form-control" value="<?= $dt['quantity'] ?>" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <label>Ukuran Barang</label>
                                                    <input name="ukuran" type="number" class="form-control" value="<?= $dt['ukuran'] ?>" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-md-12">
                                                <fieldset>
                                            ...
                                            <div class="col-md-12">
                                                <fieldset>
                                                    <button type="submit" id="form-submit" class="button" name="editBarang">Update</button>
                                                </fieldset>
                                            </div>
                                    </form>
                                <?php endforeach; ?>
